...
%\input{mls-workstation-example}

%\input{formalization}
%\input{proposal}
%\input{intransitive-noninterference}
%\input{declassification}
...
% /Users/johnhatcliff/Documents/Projects/Security/Evidence-Based-Trust-SVN/evidencetrust/papers/afosr-security-proposal-2013/latex/budget-justification.tex\input{facilities}
